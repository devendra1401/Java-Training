class AlooSabji extends Thread{
	...
	public AlooSabji() throws OilNotAvailablException, VegPowderNotAvailableException, VegetablesNotAvailableException{
	...
	public AlooSabji(long timeRequired, double waterUsed, double oilUsed, double gasUsed, double totalCost) {
		super();
	...
	public void run() {
		for(int i=1;i<=timeRequired;i++) {
			System.out.println("AlooSabji is being prepared..."+i+"\n");
			try {
				Thread.sleep(200);
	...
	public String toString() {
		return "AlooSabji [timeRequired=" + timeRequired + ", waterUsed=" + waterUsed + ", oilUsed=" + oilUsed
